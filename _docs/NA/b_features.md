...
In this article, we'll discuss some of the features that are built into BOLOS. These features are available through the [dashboard app](../b_overview#the-dashboard) and / or can be used by userspace applications.
