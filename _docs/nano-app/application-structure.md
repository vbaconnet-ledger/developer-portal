...
<div class="uk-text-center">
	<figure>
	<a href="../images/common_protocols.png" style="border-bottom:none;">
		<img src="../images/common_protocols.png" class="align-center" alt="Common protocols across BOLOS applications" />
	</a>
	<figcaption>Common protocols across BOLOS applications</figcaption>
	</figure>
</div>
<!-- --------------------------------- -->
