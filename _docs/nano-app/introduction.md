...
In order to build or compile BOLOS applications for Ledger devices, the appropriate environment must be set up. It is contained in a container image [provided here](../build).
