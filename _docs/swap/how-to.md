...
|      Endpoint     |                       Function                       |                                   Input                                  |                                                                                                                                            Output                                                                                                                                            | Payload (JSON)                                                                                                                                                                                                                                                                                                          |
|:-----------------:|:----------------------------------------------------:|:------------------------------------------------------------------------:|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| GET /pairs        | Return a list of supported pairs.                    | --                                                                       | ??                                                                                                                                                                                                                                                                                           | [ <br>    { <br>     "from":"btc", <br>     "to":"bat", <br>     "tradeMethod":[ <br>       "fixed", <br>       "float" <br>     ] <br>   }, <br>   { <br>     "from":"bat", <br>     "to":"btc", <br>     "tradeMethod":[ <br>       "fixed", <br>       "float" <br>     ] <br>   } <br> ] <br>                       |
| POST /quote       | Return a quote for a pair and amount.                | from, to, amount                                                         | quoteID, rate, expiry, method (fixed \| float)  Optional: from, to, amountFrom, amountTo                                                                                                                                                                                                     | **Success**  ```json {   "quoteId":"id1",   "from":"btc",   "to":"bat",   "amountFrom":"1",   "amountTo":"4000",   "rate":"37800.21",   "tradeMethod":"float",   "expiry":"date" } ```                                                                                                                                  |
