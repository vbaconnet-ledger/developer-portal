...
The Python loader is a tool to communicate with Ledger Nano S manage applications life cycle (if you are developing an application for the Nano X, use the [Speculos emulator](../../SP/index)).
