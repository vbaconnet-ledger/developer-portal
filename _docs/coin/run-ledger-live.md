...
- Docker
- [github.com/LedgerHQ/coin-apps](https://github.com/LedgerHQ/coin-apps) or an elf of the Nano app for LNS (create a empty folder with like : `<device>/<firmware version>/<appName>` example `nanos/1.6.1/mycoin`. The build of your Nano app must have the following format: `app_VERSION.elf`, for exemple `app_1.2.3.elf`)
